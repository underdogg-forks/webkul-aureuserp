...
class CrmServiceProvider extends ServiceProvider
{
    ...
    public function boot(): void
    {
        ...
        if (is_dir(base_path('plugins/webkul/crm/database/migrations'))) {
            $this->loadMigrationsFrom(base_path('plugins/webkul/crm/database/migrations'));
        }
        // Temporary: load migrations for shared Support models used by CRM
